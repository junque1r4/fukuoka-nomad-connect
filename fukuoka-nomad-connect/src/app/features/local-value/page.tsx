  ...
  return (
    <div className="container mx-auto py-8 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2 text-gray-800">Local Value Exchange</h1>
          <p className="text-gray-600">Supporting Fukuoka's local economy while rewarding nomads</p>
        </div>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
              ...
              <h3 className="text-lg font-medium mb-2">Pay with Solana Pay</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
              ...
              <h3 className="text-lg font-medium mb-2">Earn FUKU Tokens</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
              ...
              <h3 className="text-lg font-medium mb-2">Access Community Benefits</h3>
              <p className="text-gray-600">
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-medium mb-4 text-gray-800">For Digital Nomads</h3>
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span>Discover authentic local experiences and businesses</span>
                </li>
                <li className="flex items-start">
                  <svg className="h-6 w-6 text-[#00A9A5] mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span>Earn rewards that increase your participation in the community</span>
                </li>
                <li className="flex items-start">
                  <svg className="h-6 w-6 text-[#00A9A5] mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span>Build your local reputation and connection to Fukuoka</span>
                </li>
                <li className="flex items-start">
                  <svg className="h-6 w-6 text-[#00A9A5] mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span>Track your positive economic impact on the city</span>
                </li>
              </ul>
            </div>
            
            <div>
              <h3 className="text-xl font-medium mb-4 text-gray-800">For Local Businesses</h3>
              <ul className="space-y-3">
                <li className="flex items-start">
                  <svg className="h-6 w-6 text-[#00A9A5] mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span>Attract an international customer base of digital professionals</span>
                </li>
                <li className="flex items-start">
                  <svg className="h-6 w-6 text-[#00A9A5] mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span>Zero setup costs with simple QR code payment integration</span>
                </li>
                <li className="flex items-start">
                  <svg className="h-6 w-6 text-[#00A9A5] mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span>Lower transaction fees than traditional payment processors</span>
                </li>
                <li className="flex items-start">
                  <svg className="h-6 w-6 text-[#00A9A5] mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span>Participate in community initiatives and special promotions</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-semibold mb-6 text-gray-800">Participating Businesses</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[1, 2, 3, 4, 5, 6].map((item) => (
              <div key={item} className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm">
                ...
                <div className="p-4">
                  <h3 className="font-medium">Sample Business {item}</h3>
          ...
          <div className="mt-8 text-center">
            <p className="mb-4 text-gray-600">Are you a local business owner interested in joining our network?</p>
            <Link 
              href="#" 

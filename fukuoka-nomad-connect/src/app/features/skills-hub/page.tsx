  ...
  return (
    <div className="container mx-auto py-8 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2 text-gray-100">Skills Hub</h1>
          <p className="text-gray-300">Connect, share knowledge, and grow together in Fukuoka</p>
        </div>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
              ...
              <h3 className="text-lg font-medium mb-2 text-gray-800">Create Your Profile</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
              ...
              <h3 className="text-lg font-medium mb-2 text-gray-800">Connect & Exchange</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
              ...
              <h3 className="text-lg font-medium mb-2 text-gray-800">Build Reputation</h3>
              <p className="text-gray-600">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-semibold mb-6 text-gray-100">Featured Skills</h2>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-semibold mb-6 text-gray-100">Community Success Stories</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-medium text-gray-800">Japanese-English Language Exchange</h3>
                  <p className="text-sm text-gray-600 mb-3">Maria (Spain) & Yuki (Fukuoka)</p>
                  <p className="text-gray-600">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
              <div className="flex items-start gap-4">
                <div className="h-12 w-12 rounded-full bg-gray-200 flex-shrink-0"></div>
                <div>
                  <h3 className="font-medium text-gray-800">Website Development for Local Restaurant</h3>
                  <p className="text-sm text-gray-600 mb-3">Alex (Canada) & Tanaka Ramen</p>
                  <p className="text-gray-600">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
              <div className="flex items-start gap-4">
                <div className="h-12 w-12 rounded-full bg-gray-200 flex-shrink-0"></div>
                <div>
                  <h3 className="font-medium text-gray-800">Photography Workshop Series</h3>
                  <p className="text-sm text-gray-600 mb-3">Naomi (Fukuoka) & Digital Nomad Community</p>
                  <p className="text-gray-600">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
              <div className="flex items-start gap-4">
                <div className="h-12 w-12 rounded-full bg-gray-200 flex-shrink-0"></div>
                <div>
                  <h3 className="font-medium text-gray-800">UX/UI Redesign Collaboration</h3>
                  <p className="text-sm text-gray-600 mb-3">Liam (UK) & Hiroshi (Fukuoka)</p>
                  <p className="text-gray-600">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-semibold mb-6 text-gray-100">Community Events</h2>
          
          <div className="space-y-4">
            <div className="bg-white border border-gray-200 rounded-lg p-5">
              <div className="flex flex-col md:flex-row md:items-center justify-between">
                <div>
                  <h3 className="font-medium text-lg text-gray-800">Web3 Development Workshop</h3>
                  <p className="text-gray-600">Learn the basics of creating dApps on Solana</p>
                  <p className="text-sm text-gray-600 mt-1">July 15, 2025 • FCC Coworking Space</p>
                </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-5">
              <div className="flex flex-col md:flex-row md:items-center justify-between">
                <div>
                  <h3 className="font-medium text-lg text-gray-800">Multi-cultural Business Networking</h3>
                  <p className="text-gray-600">Connect with local businesses and international professionals</p>
                  <p className="text-sm text-gray-600 mt-1">July 22, 2025 • Fukuoka Innovation Hub</p>
                </div>
                <div className="mt-4 md:mt-0">
                  <span className="inline-block bg-[#E6F7F7] text-[#00A9A5] py-1 px-3 rounded-full text-sm font-medium">
                    32 Spots Left
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-5">
              <div className="flex flex-col md:flex-row md:items-center justify-between">
                <div>
                  <h3 className="font-medium text-lg text-gray-800">Design Thinking for Social Impact</h3>
                  <p className="text-gray-600">Learn how to apply design thinking to community challenges</p>
                  <p className="text-sm text-gray-600 mt-1">August 5, 2025 • Fukuoka City Library</p>
                </div>
                <div className="mt-4 md:mt-0">
                  <span className="inline-block bg-[#E6F7F7] text-[#00A9A5] py-1 px-3 rounded-full text-sm font-medium">
                    8 Spots Left
